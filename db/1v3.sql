...
--
-- Name: det_aplicaciones_id_seq; Type: SEQUENCE; Schema: public; Owner: rusa
--

CREATE SEQUENCE public.det_aplicaciones_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.det_aplicaciones_id_seq OWNER TO rusa;

--
-- Name: det_aplicaciones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rusa
--

ALTER SEQUENCE public.det_aplicaciones_id_seq OWNED BY public.det_aplicaciones.id;
...
--
-- Name: det_serv_id_seq; Type: SEQUENCE; Schema: public; Owner: rusa
--

CREATE SEQUENCE public.det_serv_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.det_serv_id_seq OWNER TO rusa;

--
-- Name: det_serv_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rusa
--

ALTER SEQUENCE public.det_serv_id_seq OWNED BY public.det_serv.id;
...
--
-- Name: det_aplicaciones id; Type: DEFAULT; Schema: public; Owner: rusa
--

ALTER TABLE ONLY public.det_aplicaciones ALTER COLUMN id SET DEFAULT nextval('public.det_aplicaciones_id_seq'::regclass);


--
-- Name: det_serv id; Type: DEFAULT; Schema: public; Owner: rusa
--

ALTER TABLE ONLY public.det_serv ALTER COLUMN id SET DEFAULT nextval('public.det_serv_id_seq'::regclass);
...
COPY public.det_aplicaciones (id_aplica, resp, esc_1, esc_2, esc_3, id) FROM stdin;
10	2	4	3	1	1
4	1	3	4	2	2
5	2	1	4	3	3
3	3	2	1	4	4
...
COPY public.det_serv (id_serv, id_prod, id_pai, id_aplica, ponderacion, id) FROM stdin;
1	2	1	10	100	1
1	2	1	5	100	2
1	1	1	5	100	3
2	1	7	4	100	4
...
--
-- Name: det_aplicaciones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: rusa
--

SELECT pg_catalog.setval('public.det_aplicaciones_id_seq', 4, true);


--
-- Name: det_serv_id_seq; Type: SEQUENCE SET; Schema: public; Owner: rusa
--

SELECT pg_catalog.setval('public.det_serv_id_seq', 4, true);
...
--
-- Name: det_aplicaciones det_aplicaciones_pkey; Type: CONSTRAINT; Schema: public; Owner: rusa
--

ALTER TABLE ONLY public.det_aplicaciones
    ADD CONSTRAINT det_aplicaciones_pkey PRIMARY KEY (id);


--
-- Name: det_serv det_serv_pkey; Type: CONSTRAINT; Schema: public; Owner: rusa
--

ALTER TABLE ONLY public.det_serv
    ADD CONSTRAINT det_serv_pkey PRIMARY KEY (id);
