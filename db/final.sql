...
CREATE TABLE public.det_aplicaciones (
    ...
    nivel integer DEFAULT 9 NOT NULL
);
...
COPY public.det_aplicaciones (id_aplica, id_vel, nivel) FROM stdin;
5	1	0
5	2	1
5	4	2
5	3	3
...
COPY public.veladores (id_veladores, nombre, apellido, telefono, sup_inmediato, departamento) FROM stdin;
1	Lucas	Jojo	15-666-6666	Matias	S&P
2	Gaston	CAT	15-666-5689	Caro	incendiado
3	Jorge	Billete	15-666-1234	Gabriel	Networking
4	Esequiel	Poket	15-666-7892	Lucas	S&P
\.
...
--
-- Name: det_aplicaciones det_aplicaciones_id_vel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rusa
--

ALTER TABLE ONLY public.det_aplicaciones
    ADD CONSTRAINT det_aplicaciones_id_vel_fkey FOREIGN KEY (id_vel) REFERENCES public.veladores(id_veladores) NOT VALID;
